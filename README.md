# AI-prompts
Miscellaneous assortment of AI prompts and markdown input files.

 - [`writing-R-code-for-human-readers`]([https://github.com/mackaytc/AI-prompts/blob/main/manuscript-copyedits.txt](https://github.com/mackaytc/AI-prompts/blob/main/writing-R-code-for-human-readers.md)) I use this markdown file when I want AI to generate code that's readable for humans. 
   - Focus is on neatly-formatted code that doesn't spam too many `cat()` and `print()` function calls; AI has a tendancy to dump out way too much code.
